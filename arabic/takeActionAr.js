		...
		if (max['1'] > 70){
			GraphAPI.sendPlainMessage(recipientId, max['0'] +' يا '+ context.userData.first_name + ' عامل ايه؟').then(()=>{
					...
					if (max['1'] > 70){
						...
						let thank = ['شكرا ','الف شكر ','الله ينور ','شغل عالي','برافو','احسنت','بوت ممتاز','رائع','انت رائع','كويس']
						...
						if(max['1'] > 70){
							...
							let  insult = ['يا خول ','يا متناك','ياع عرص','يا علق ','كسمك','متناك','عرص','اهبل ','هبيط','حمار','انت حمار','بقرة','حموسة','غبي','انت غبي','طيزك','طيزك حمرا','كس اختك']
							let max = fuzzChech(insult,context.msg);
							if(max['1'] > 70){
								let insultRes = ['عيب كده احترم نفسك','متحترم نفسك يا عم انت 😡😡 ','مينفعش كده خليك معترم 😡😡','الله يسمحك 😡😡','الشتيمة بتلف تلف وترجع لصاحبها 😡😡','متحترم نفسك يا جدع انت 😡😡 ','عيب كده اله','ملكش دعوة 😛😛 ']
