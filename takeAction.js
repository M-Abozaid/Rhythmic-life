		...
		if (max['1'] > 70){
			GraphAPI.sendPlainMessage(recipientId, max['0'] + context.userData.first_name + ' How are you؟').then(()=>{
					...
					if (max['1'] > 70){
						...
						if(max['1'] > 70){
								let thenkRes = ['That\'s very kind of you.😊','Thank you','Aww you\'re so cute','Aww you such an angel 😊😊 ','Thank you. I appreciate your saying that.','That\'s encouraging. ','Thank you you are so sweet ']
